...
// Functions are callable programmer task
...
function handleSlide(e){
    ...
    if(["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown"].includes(e.code)){
        ...
        if(e.code == "ArrowDown" && canMoveDown()){
            slideDown();
            setTwo();
        }
...
function slideLeft(){
    ...
    for (let r=0; r < rows; r++){
        ...
        // All tiles values per row are saved in the container
        let row = board[r];
    ...
    for(let r=0; r < rows; r++){
        for(let c=0; c < columns; c++){
            ...
            if(board[r][c] == 2048 && is2048Exist == false){
                ...
                alert("Amazing, You got 4096! Congratulations!");
                is4096Exist = true;
            }
